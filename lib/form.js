...
var Form = /*#__PURE__*/function () {
  function Form(fields) {
    ...
    _defineProperty(this, "prevValue", {});
  ...
  _createClass(Form, [{
    ...
    value: function _add(fieldVal) {
      ...
      if (fieldVal instanceof _fields.Fields) {
        fieldVal.stateChange.subscribe(function () {
          _this5.stateChange.publish(_this5.value, _this5.prevValue);
        });
        return fieldVal;
      } else {
    ...
    key: "clearAllFields",
    value: function clearAllFields(formFieldsOrFieldObject) {
      var _this6 = this;

      formFieldsOrFieldObject = formFieldsOrFieldObject || this.fields;

      if (formFieldsOrFieldObject instanceof _field.Field) {
        formFieldsOrFieldObject.value = '';
      } else {
        Object.keys(formFieldsOrFieldObject).forEach(function (k) {
          if (formFieldsOrFieldObject[k] instanceof _field.Field) {
            formFieldsOrFieldObject[k].value = '';
          } else if (formFieldsOrFieldObject[k] instanceof _fields.Fields) {
            formFieldsOrFieldObject[k].fields.forEach(function (f) {
              _this6.clearAllFields(f);
            });
          } else if (formFieldsOrFieldObject[k] instanceof Form) {
            _this6.clearAllFields(formFieldsOrFieldObject[k].fields);
          }
        });
      }
    }
